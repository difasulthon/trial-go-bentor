        ...
        mConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setTitle("Konfirmasi")
                        .setMessage("Apakah anda yakin untuk menyimpan?")
        ...
        if (resultUri != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(CustomerSettingsActivity.this, "upload image error", Toast.LENGTH_SHORT).show();
                }
            });
            ...
            Toast.makeText(CustomerSettingsActivity.this, "resultUri is null", Toast.LENGTH_SHORT).show();
        }
        finish();
    }
